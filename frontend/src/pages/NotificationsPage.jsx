...
import { BellIcon, ClockIcon, MessageSquareIcon, UserCheck2Icon } from "lucide-react";
        ...
        {isLoading ? (
          ...
          <>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="avatar w-14 h-14 rounded-full bg-base-300">
                              <img src={request.sender.profilePic} alt={request.sender.userName} className="rounded-full" />
                            </div>
                            <div>
                              <h3 className="font-semibold">{request.sender.userName}</h3>
                              <div className="flex fkex-wrap gap-1.5 ml-1">
            ...
            {acceptedRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  <BellIcon className="h-5 text-success"/>
                  New Connections
                </h2>
