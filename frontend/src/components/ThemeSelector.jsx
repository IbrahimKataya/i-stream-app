...
const ThemeSelector = () => {
  ...
  return (
    <div className="dropdown dropdown-end">
      ...
      rounded-2xl w-56 border border-base-content/10 max-h-80 overflow-y-auto cursor-pointer">
          ...
          {THEMES.map((themeOption) => (
            ...
            className={`
              ...
              ${
                ...
                ? "bg-primary/10 text-primary hover:cursor-default"
            ...
            onClick={() => setTheme(themeOption.name)}>
              ...
              <div className="ml-auto flex gap-1 bg-transparent" data-theme={themeOption.name}>
