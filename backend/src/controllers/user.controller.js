...
export async function getUserFriends(req,res){
    try {
        ...
        .populate("friends", "userName fullName profilePic nativeLanguage learningLanguage")
...
export async function sendFriendRequest(req,res){
    try {
        ...
        console.log("Error is sendFriendRequest controller: ", error.message);
        res.status(500).json({ message: "Internal Server Error" })
    }
}
...
export async function acceptFriendRequest(req, res){
    try {
        ...
        // Comparison (need toString) since the 2 sides are of 
        // different types (objectId vs string)
        ...
        // $addToSet: adds elements to an array on;y if they do not already exists.
